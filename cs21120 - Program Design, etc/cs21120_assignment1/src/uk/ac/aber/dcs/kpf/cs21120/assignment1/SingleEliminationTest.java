...
public class SingleEliminationTest {
	...
	public void setup(){
        ...
        managerOne = IManagerFactory.getManager("uk.ac.aber.dcs.kpf.cs21120.assignment1.SingleElimination");
        managerTwo = IManagerFactory.getManager("uk.ac.aber.dcs.kpf.cs21120.assignment1.SingleElimination");
        managerThree = IManagerFactory.getManager("uk.ac.aber.dcs.kpf.cs21120.assignment1.SingleElimination");
        managerFour = IManagerFactory.getManager("uk.ac.aber.dcs.kpf.cs21120.assignment1.SingleElimination");
	...
	//Tests if a next match is possible, which it should be with 6 players
	@Test
	...
	public void setMatchWinner(){	
		...
		matchThree = managerThree.nextMatch();
