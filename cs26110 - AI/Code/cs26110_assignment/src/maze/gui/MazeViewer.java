...
public class MazeViewer extends JFrame {
    ...
    public MazeViewer() {
        ...
        //Made text field a little wider, sometimes with larger nodes explored the full value gets cut off
